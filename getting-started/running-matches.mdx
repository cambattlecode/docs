...
Opens the visualiser in your browser. Supports play/pause, turn scrubbing, speed control, and keyboard navigation.
...
<Warning>
  Remote test runs are rate-limited: max 10 test/unrated matches per 5 minutes, plus a 5-minute cooldown per matchup.
</Warning>
