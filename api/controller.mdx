...
<ResponseField
  name="get_attackable_tiles_from(position: Position, direction: Direction, turret_type: EntityType)"
  type="list[Position]"
>
...
<ResponseField
  name="get_stored_resource(id: int | None = None)"
...
<ResponseField
  name="get_stored_resource_id(id: int | None = None)"
  type="int | None"
>
...
<ResponseField
  name="get_nearby_tiles(dist_sq: int | None = None)"
  type="list[Position]"
>
...
<ResponseField
  name="get_nearby_entities(dist_sq: int | None = None)"
  type="list[int]"
>
...
<ResponseField
  name="get_nearby_buildings(dist_sq: int | None = None)"
  type="list[int]"
>
...
<ResponseField
  name="get_nearby_units(dist_sq: int | None = None)"
  type="list[int]"
>
...
<ResponseField
  name="can_build(entity_type: EntityType, position: Position, extra: Direction | Position | None = None)"
  type="bool"
>
...
<ResponseField
  name="build(entity_type: EntityType, position: Position, extra: Direction | Position | None = None)"
  type="int"
>
...
<ResponseField
  name="can_fire_from(position: Position, direction: Direction, turret_type: EntityType, target: Position)"
  type="bool"
>
...
<ResponseField
  name="can_launch(bot_pos: Position, target: Position)"
  type="bool"
>
...
<ResponseField
  name="draw_indicator_line(pos_a: Position, pos_b: Position, r: int, g: int, b: int)"
  type="None"
>
...
<ResponseField
  name="draw_indicator_dot(pos: Position, r: int, g: int, b: int)"
  type="None"
>
