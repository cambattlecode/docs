---
title: Core
description: Your central building — if it's destroyed, you lose.
---

<img src="/images/entities/core.png" alt="Core" style={{ width: 80, float: "right", marginLeft: 16 }} />
...
![Core range — blue is vision, red is action radius](/images/ranges/core.png)
