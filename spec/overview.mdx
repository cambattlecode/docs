...
<CardGroup cols={4}>
  ...
  <Card title="Wall">
    <img src="/images/resources/wall.jpg" alt="Wall" style={{ width: 32, marginBottom: 8 }} />
    Impassable, cannot build
  </Card>
  <Card title="Titanium ore">
    <img src="/images/resources/titanium-ore.png" alt="Titanium ore" style={{ width: 32, marginBottom: 8 }} />
    Harvesters mine titanium
  </Card>
  <Card title="Axionite ore">
    <img src="/images/resources/axionite-ore.png" alt="Axionite ore" style={{ width: 32, marginBottom: 8 }} />
    Harvesters mine raw axionite
  </Card>
</CardGroup>
