...
<Tip>
  Harvesters are expensive (80 Ti base) but reduce your cost scaling by 10% each. Building harvesters early is key to keeping costs down.
</Tip>
...
<Warning>
  Foundries have the highest scaling contribution at 100%. Each foundry you build significantly reduces costs across the board — but the 120 Ti base cost is steep.
</Warning>
