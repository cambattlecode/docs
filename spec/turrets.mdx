...
blocker is legal. Using refined axionite as ammo deals **30 damage** instead of
10.
...
<Info>
  Gunners can rotate 45 degrees left or right with `c.rotate(direction)`. This
  costs **10 Ti** from the global pool and applies a **1-turn cooldown**. Use
